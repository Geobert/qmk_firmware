...
[_GAME] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
     BP_EQL, BP_AGRV, BP_Y,    BP_X,  BP_DOT,  BP_K,  KC_MPLY,  LAUNCH,  BP_QUOT, BP_Q,   BP_G,    BP_H,    BP_F,   BP_CCED ,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
                 KC_ENT, KC_LALT, KC_LCTL, TT(_RED), KC_SPC,     KC_ENT, TT(_BLUE), KC_RALT, KC_BSPC, KC_DEL
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
...
[_RED] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                            |--------+-------+--------+--------+--------+---------|
  _______,   UNDO,   KC_LALT, KC_RCTRL, KC_LSFT, ALGR(KC_TAB),                       KC_PGUP,  KC_LEFT, KC_DOWN, KC_RGHT, KC_LGUI, KC_PSCR,
  //|------+-------+--------+--------+--------+------      |  ===  |      |  ===  |--------+-------+--------+--------+--------+---------|
...
[_BLUE] = LAYOUT(
  ...
  _______, KC_F1,  KC_F2,   KC_F3,   KC_F4,   KC_F5,                                 KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,
  //|------+-------+--------+--------+--------+------|                             |--------+-------+--------+--------+--------+---------|
  _______,  BP_DLR, BP_SHARP, BP_LABK, BP_RABK, BP_ARRO,                             KC_PMNS , KC_P7,  KC_P8,  KC_P9,   KC_PSLS, KC_F12,
  //|------+-------+--------+--------+--------+------|                             |--------+-------+--------+--------+--------+---------|
  _______,  BP_PIPE, BP_LCBR ,BP_RCBR,  BP_AMP, BP_FARRO,                             KC_PPLS , RSFT_T_P4, ALGR_T_P5, KC_P6, KC_PAST, BP_EURO,
  //|------+-------+--------+--------+--------+------|  ===  |             |  ===  |--------+-------+--------+--------+--------+---------|
  BP_PERC ,BP_BSLS, BP_PERC, BP_DLR, BP_LBRC,BP_RBRC,_______,              LAUNCH, KC_PDOT , KC_P1,  KC_P2, KC_P3, KC_INS,   BP_POUND,
  //|------+-------+--------+--------+--------+------|  ===  |             |  ===  |--------+-------+--------+--------+--------+---------|
...
const rgblight_segment_t PROGMEM layer_bepo_lights[] = RGBLIGHT_LAYER_SEGMENTS(
...
const rgblight_segment_t PROGMEM layer_blue_lights[] = RGBLIGHT_LAYER_SEGMENTS(
...
const rgblight_segment_t* const PROGMEM my_rgb_layers[] = RGBLIGHT_LAYERS_LIST(
    layer_bepo_lights,
	layer_blue_lights,// overrides layer 1
	layer_red_lights
);

layer_state_t layer_state_set_user(layer_state_t state) {
	// rgblight_set_layer_state(0, layer_state_cmp(state, _DEFAULTS) && layer_state_cmp(default_layer_state,_BEPO));
