...
[_BLUE] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                             |--------+-------+--------+--------+--------+---------|
  _______,  BP_PIPE, BP_RCBR ,BP_LCBR,  BP_AMP, BP_FARRO,                             KC_PPLS , RSFT_T_P4, ALGR_T_P5, KC_P6, KC_PAST, BP_EURO,
  //|------+-------+--------+--------+--------+------|  ===  |             |  ===  |--------+-------+--------+--------+--------+---------|
  KC_NO ,BP_BSLS, BP_PERC, BP_DLR, BP_LBRC,BP_RBRC,_______,              LAUNCH, KC_PDOT , KC_P1,  KC_P2, KC_P3, KC_INS,   BP_POUND,
  //|------+-------+--------+--------+--------+------|  ===  |             |  ===  |--------+-------+--------+--------+--------+---------|
