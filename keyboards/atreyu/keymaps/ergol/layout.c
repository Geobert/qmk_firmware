...
[_ERGOL] = LAYOUT(
    KC_ESC  , KC_1, KC_2,    KC_3,    KC_4,      KC_5,                        KC_6,     KC_7,     KC_8,     KC_9,    KC_0,    TLG,
    ...
    KC_ENT  ,       KC_LALT, KC_LCTL, MO(_NAV),  KC_SPC, KC_DEL,     KC_BSPC, KC_RSFT, OSL(_SYM), OSL(_NUM), KC_MPLY,           LAUNCH
),
...
[_NAV] = LAYOUT(
    ...
    KC_MUTE,  MV_LFT,  SPOTI_FAV, C(KC_SPC),  FFX_DEL,  C(KC_PSCR),                    DEL_LINE,   WD_LFT,    KC_UP,    WD_RGT,  XXXXXXX,    KC_F12,
    KC_MNXT,  UNDO,    KC_LALT,   KC_LCTL,    KC_LSFT,  ALGR(KC_TAB),                  KC_PGUP,    KC_LEFT,   KC_DOWN,  KC_RGHT, XXXXXXX,    KC_LGUI,
...
[_SYM] = LAYOUT(
    ...
    CW_TOGG,             LLOCK,         KC_LCTL,       _______,       KC_SPC,     KC_DEL,  KC_BSPC,  MOD_RSFT,        TG(_SYM),       MO(_NUM),     _______,                      KC_ENT
),

[_MEDIA] = LAYOUT(
    _______,  KC_F1,    KC_F2,     KC_F3,       KC_F4,      KC_F5,                    KC_F6,     KC_F7,     KC_F8,    KC_F9,  KC_F10,  KC_F11,
    _______,  _______,  EL_F,      KC_UP,       EL_O,       _______,                  KC_PPLS,   KC_P7,     KC_P8,    KC_P9,  KC_PSLS, KC_F12,
    KC_NUM ,  _______,  KC_LEFT,   KC_DOWN,     KC_RIGHT,   _______,                  KC_PMNS,   KC_P4,     KC_P5,    KC_P6,  KC_PAST, S(KC_1),
    _______,  _______,  _______,   _______,     _______,    _______,                  KC_P0,     KC_P1,     KC_P2,    KC_P3,  KC_PDOT, EL_POUND,
    _______,            _______,   TG(_MEDIA),  TG(_MEDIA), KC_SPC, _______,   EL_DOT, _______,    TG(_SYM),  KC_BSPC,  _______,         TG(_MEDIA)
)
};
