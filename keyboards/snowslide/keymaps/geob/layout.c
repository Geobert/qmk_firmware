...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BEPO] = LAYOUT(
        ...
        LAUNCH,  KC_LSFT, BP_A,    BP_U,    BP_I,    BP_E,    BP_COMM,   KC_DEL,     KC_BSPC, BP_C,      BP_T,    BP_S,    BP_R,    BP_N,    BP_M,   BP_GRV,
                 BP_EQL,  BP_AGRV, BP_Y,    BP_X,    BP_DOT,  BP_K,      KC_BSPC,    KC_DEL,  BP_QUOT,   BP_Q,    BP_G,    BP_H,    BP_F,    BP_CCED,
                 KC_ENT,                    KC_LALT, KC_LCTL, TT(_RED),  KC_SPC,     KC_ENT,  TT(_BLUE), KC_RALT, KC_RSFT,                   PASSMAN
    ),

    [_GAME] = LAYOUT(
                 KC_ESC,  BP_DQUO, BP_LDAQ, BP_RDAQ, BP_LPRN, BP_RPRN,                        BP_AT,     BP_PLUS, BP_MINS, BP_SLSH, BP_ASTR, BP_W,
                 KC_TAB,  BP_B,    BP_EACU, BP_CCED, BP_O,    BP_EGRV,                        BP_DCIR,   BP_V,    BP_D,    BP_L,    BP_J,    BP_Z,
        LAUNCH,  KC_LSFT, BP_A,    BP_A,    BP_S,    BP_D,    BP_COMM,   KC_DEL,     KC_BSPC, BP_C,      BP_T,    BP_S,    BP_R,    BP_N,    BP_M,   BP_GRV,
                 BP_EQL,  BP_AGRV, BP_Y,    BP_X,    BP_DOT,  BP_K,      KC_BSPC,    KC_DEL,  BP_QUOT,   BP_Q,    BP_G,    BP_H,    BP_F,    BP_CCED,
                 KC_ENT,                    KC_LALT, KC_LCTL, TT(_RED),  KC_SPC,     KC_ENT,  TT(_BLUE), KC_RALT, KC_RSFT,                   PASSMAN
    ),
    ...
    [_RED] = LAYOUT(
                 ...
                 _______,  MV_LFT,  SPOTI_FAV, C(KC_SPC), KC_MPLY,  C(KC_PSCR),                        DEL_LINE,   WD_LFT,    KC_UP,   WD_RGT,  KC_APP,  KC_F12,
    ...
    [_BLUE] = LAYOUT(
                 _______,  KC_F1,    KC_F2,     KC_F3,     KC_F4,    KC_F5,                             KC_F6,      KC_F7,   KC_F8,  KC_F9,  KC_F10,  KC_F11,
                 _______,  KC_NO,    BP_SHARP,  BP_LABK,   BP_RABK,  BP_ARRO,                           KC_PMNS,    KC_P7,   KC_P8,  KC_P9,  KC_PSLS, KC_F12,
        KC_NO,   _______,  BP_PIPE,  BP_RCBR,   BP_LCBR,   BP_AMP,   BP_FARRO,   KC_ENT,       KC_BSPC, KC_PPLS,    KC_P4,   KC_P5,  KC_P6,  KC_PAST, BP_EURO, KC_INS,
                 _______,  BP_BSLS,  BP_PERC,   BP_DLR,    BP_LBRC,  BP_RBRC,    KC_DEL,       KC_RALT, KC_PDOT,    KC_P1,   KC_P2,  KC_P3,  BP_DLR,  BP_POUND,
                 A(KC_F4),                      _______,   _______,  _______,    BP_UNDS,      KC_ENT,  TG(_BLUE),  KC_P0,   _______,                 _______
    )
};
