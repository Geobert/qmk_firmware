...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RED] = LAYOUT(
        ...
        KC_MNXT,   _______,  UNDO,    KC_LALT,   KC_LCTRL,  KC_LSFT,  ALGR(KC_TAB), LLOCK,                 KC_BSPC, KC_PGUP,    KC_LEFT,   KC_DOWN, KC_RGHT, KC_NO,   KC_LGUI, KC_PSCR,
                   KC_CAPS,  REDO,    CUT,       COPY,      PASTE,    DITTO,        TLG,                   KC_MPRV, KC_PGDOWN,  KC_HOME,   KC_NO,   KC_END,  BP_F,    KC_NO,
                   KC_MPLY,                                 _______,  _______,      TG(_RED),     KC_SPC,  KC_ENT,  KC_VOLU,    KC_VOLD,   KC_NO,                     TGL_GAME
    ),
