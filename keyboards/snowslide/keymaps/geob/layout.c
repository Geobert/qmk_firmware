...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BEPO] = LAYOUT(
        ...
        RCS(BP_F), KC_LSFT, BP_A,    BP_U,    BP_I,    BP_E,    BP_COMM, KC_DEL,                         KC_BSPC, BP_C,      BP_T,    BP_S,    BP_R,    BP_N,    BP_M,   LAUNCH,
                   BP_EQL,  BP_AGRV, BP_Y,    BP_X,    BP_DOT,  BP_K,    KC_BSPC,                        BP_GRV,  BP_QUOT,   BP_Q,    BP_G,    BP_H,    BP_F,    BP_CCED,
                   KC_ENT,                             KC_LALT, KC_LCTL, MO(_RED),  KC_SPC,     KC_ENT,  MO(_BLUE), KC_RALT, KC_RSFT,                            PASSMAN
    ),

    [_GAME] = LAYOUT(
                 KC_ESC,  BP_DQUO, BP_LDAQ, BP_RDAQ, BP_LPRN, BP_RPRN,                                          BP_AT,     BP_PLUS, BP_MINS, BP_SLSH, BP_ASTR, BP_W,
                 KC_TAB,  BP_B,    BP_EACU, BP_CCED, BP_O,    BP_EGRV,                                          BP_DCIR,   BP_V,    BP_D,    BP_L,    BP_J,    BP_Z,
        C(BP_S), KC_LSFT, BP_A,    BP_A,    BP_S,    BP_D,    BP_COMM, KC_DEL,                         KC_BSPC, BP_C,      BP_T,    BP_S,    BP_R,    BP_N,    BP_M,   LAUNCH,
                 BP_EQL,  BP_AGRV, BP_Y,    BP_X,    BP_DOT,  BP_K,    KC_BSPC,                        BP_GRV,  BP_QUOT,   BP_Q,    BP_G,    BP_H,    BP_F,    BP_CCED,
                 KC_ENT,                             KC_LALT, KC_LCTL, MO(_RED),  KC_SPC,     KC_ENT,  MO(_BLUE), KC_RALT, KC_RSFT,                            PASSMAN
    ),
    ...
    [_BLUE] = LAYOUT(
        ...
        LLOCK,   _______,  BP_PIPE,  BP_RCBR,   BP_LCBR,   BP_AMP,   BP_FARRO,  KC_ENT,                         KC_BSPC,    KC_PPLS,   KC_P4,   KC_P5,  KC_P6,  KC_PAST, BP_EURO, KC_INS,
                 _______,  BP_BSLS,  BP_PERC,   BP_DLR,    BP_LBRC,  BP_RBRC,   KC_DEL,                         KC_RALT,    KC_P0,     KC_P1,   KC_P2,  KC_P3,  BP_DLR,  BP_POUND,
                 A(KC_F4),                                 _______,   _______,  _______, BP_UNDS,      KC_ENT,  TG(_BLUE),  KC_PDOT,  _______,                           A(KC_F4)
    )
};
